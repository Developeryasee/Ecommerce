...
import { BrandData, carouselImages, CategoryData, FlashSalesData, Gallery, subCategory } from "../../DATA/WomenData";
import CustomFonts from "../../Themes/CustomFonts";
import { globalstyle } from "../../Themes/GlobalStyle";
export default function WomenDasboard() {
    ...
    return (
        <View style={globalstyle.container}>
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <Text style={[CustomFonts.SIZES.h7, CustomFonts.COLORS.black, globalstyle.mt15, globalstyle.mb15]}>Style Gallery</Text>
